...
@Slf4j
public class SelectPanelStylesAndAtributesNOTDONE extends BaseTest {
    ...
    @Test
    public void C1080SelectPanelStylesAndAtributes() throws FileNotFoundException {
        log.info("Starting the C1080 Select a Panel - styles / atributes test...");
        ...
        interfaceBuilderPage.editingTheStylesTab();
