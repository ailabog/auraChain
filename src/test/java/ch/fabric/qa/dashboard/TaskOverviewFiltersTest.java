...
public class TaskOverviewFiltersTest extends BaseTest {
	...
	@Test
	public void C1109TaskOverviewFilters() {
		logger.info("Starting the task overview filters test..");
		...
		dashboardPage.filterTaskOverviewGraph();
	}
