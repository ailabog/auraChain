...
public class ApplicationsChangePagesTest extends BaseTest {
	...
	@Test
	public void C1113ApplicationsChangePages() {
		logger.info("Starting the applications - change pages test..");
		...
		dashboardPage.applicationsSectionChangePage();
	}
