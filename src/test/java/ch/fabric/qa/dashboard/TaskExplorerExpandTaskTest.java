...
public class TaskExplorerExpandTaskTest extends BaseTest {
	...
	@Test
	public void C1116TaskExplorerExpandTask() {
		logger.info("Starting the task explorer - expand task test..");
		...
		dashboardPage.clickExpandTaskGreenArrow();
