...
public class TaskExplorerFiltersTest extends BaseTest {
	...
	@Test
	public void C1110TaskExplorerFilters() {
		logger.info("Starting the task explorer filters test..");
		...
		dashboardPage.filterTaskExplorerSection();
	}
