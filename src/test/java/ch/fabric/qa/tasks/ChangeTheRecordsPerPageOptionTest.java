...
public class ChangeTheRecordsPerPageOptionTest extends BaseTest {
    ...
    @Test(priority = 0)
    public void C1153ChangeTheRecordsPerPageOption() {
        logger.info("Starting the Change the records per page option test..");
//        loginPage.load(environment.getURL());
        ...
        tasksPage.chooseNoOfRecordsPerPage();
    }
