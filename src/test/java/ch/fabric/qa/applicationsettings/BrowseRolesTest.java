...
public class BrowseRolesTest extends BaseTest {
	...
	//Done
	@Test(priority = 0)
	public void C1102BrowseRolesTest() {
		logger.info("Starting browse roles test..");
		...
		applicationSettingsPage.browseRoles();
