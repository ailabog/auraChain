...
public class UpdateElementsTest extends BaseTest {
	...
	//Done
	@Test(priority = 0)
	public void C1106UpdateElementsTest() {
		logger.info("Starting update elements test..");
		...
		applicationSettingsPage.syncElements();
		applicationSettingsPage.updateElements();
	}
